	...
	<div class="backImage_view1">
		<div class="find_id_box">
		 <form:form action="${root}user/find_id_pro" method="post" modelAttribute="findIdBean" >
					<form:label path="user_name" class="id">이름</form:label>
					<div class="mb-3 w-75" id="ID_form">
					<form:input path="user_name" class="form-control" id="exampleFormControlInput16" />
					</div>
					<form:label path="user_phone" class="pw">휴대폰 번호</form:label>
					<div class="mb-3 w-75" id="PW_form">
						<form:input path="user_phone" class="form-control" id="exampleFormControlInput17" />
					</div>
			<div class="row">
