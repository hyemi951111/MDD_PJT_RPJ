...
<title>햄 반려견 사이트 만들기 프로젝트_diary_write</title>
</head>
	...
	<div class="backImage_view2">
		<div
			...
			<div class="row col-lg-5">
				<div class="col-lg-12">
					<div class="card">
					 <form:form action="${root}diary/diary_write_pro" method="post" modelAttribute="addDiaryBean" >
							...
							<div class="diary_in_button">
								<div class="row">
									...
									<div class="col text-center ml-30">
										<form:button class="btn btn-primary" onclick="color();">등록</form:button>
									</div>
								</div>
							</div>
						</div>
